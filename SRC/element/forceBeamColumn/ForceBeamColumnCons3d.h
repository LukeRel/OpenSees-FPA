...
// $Source: /usr/local/cvs/OpenSees/SRC/element/forceBeamColumn/ForceBeamColumnCons3d.h,v $
...
#ifndef ForceBeamColumnCons3d_h
#define ForceBeamColumnCons3d_h
...
class ForceBeamColumnCons3d: public Element
{
 public:
  ForceBeamColumnCons3d();
  ForceBeamColumnCons3d(int tag, int nodeI, int nodeJ, 
  ...
  const char *getClassType(void) const {return "ForceBeamColumnCons3d";};
  ...
  friend OPS_Stream &operator<<(OPS_Stream &s, ForceBeamColumnCons3d &E);        
