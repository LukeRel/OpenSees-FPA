...
#ifndef DispBeamColumnBond2d_h
#define DispBeamColumnBond2d_h
...
class DispBeamColumnBond2d : public Element
{
  public:
    DispBeamColumnBond2d(int tag, int nd1, int nd2,
		     int numSections, SectionForceDeformation **s,
		     BeamIntegration &bi, CrdTransf &coordTransf,
		     double rho = 0.0, int cMass = 0);
    DispBeamColumnBond2d();
    ~DispBeamColumnBond2d();

    const char *getClassType(void) const {return "DispBeamColumnBond2d";};
