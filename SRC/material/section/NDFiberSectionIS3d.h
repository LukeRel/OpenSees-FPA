...
// Modified: LP
//
// Description: This file contains the class implementation of NDFiberSectionIS3d.

#ifndef NDFiberSectionIS3d_h
#define NDFiberSectionIS3d_h
...
class NDFiberSectionIS3d : public SectionForceDeformation
{
  public:
    NDFiberSectionIS3d(); 
    NDFiberSectionIS3d(int tag, int numFibers, Fiber **fibers, double a = 1.0, bool compCentroid=true);
    NDFiberSectionIS3d(int tag, int numFibers, double a = 1.0, bool compCentroid=true);
    NDFiberSectionIS3d(int tag, int numFibers, NDMaterial **mats,
		     SectionIntegration &si, double a = 1.0, bool compCentroid=true);
    ~NDFiberSectionIS3d();

    const char *getClassType(void) const {return "NDFiberSectionIS3d";};
  ...
  protected:
    ...
    double   *matData;              // data for the materials [yloc, zloc, area and eps0]
