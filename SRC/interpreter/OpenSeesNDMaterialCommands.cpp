...
namespace {
  ...
  static void* J2BeamFiber2Dor3D (void)
  {
	...
	nDMaterialsMap.insert(std::make_pair("Condensation1D", &OPS_Condensation1D));
	nDMaterialsMap.insert(std::make_pair("CondConf", &OPS_CondConf));
	...
	nDMaterialsMap.insert(std::make_pair("Condensation", &OPS_Condensation));
